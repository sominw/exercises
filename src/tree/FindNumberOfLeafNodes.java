...
public class FindNumberOfLeafNodes {
	...
	public static int findNumberOfLeafNodes(TreeNode<Integer> node) {
		if (node == null)
			return 0;
		...
		for (int i = 0; i < node.children.size(); i++) {
			numLeafNodes += findNumberOfLeafNodes(node.children.get(i));
		}
		return numLeafNodes;
	}
	...
	public static void main(String[] args) {
		...
		System.out.println("Total number of leaf nodes: " + findNumberOfLeafNodes(root));
	}
}
